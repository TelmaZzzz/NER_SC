...
--batch_size=16 \
--output_path="$ROOT/output/ans_15.csv" \
--ensemble \
--model1="$ROOT/model/SC/2021_11_11_13_22_score_0.5147.pkl" \
--model2="$ROOT/model/SC/2021_11_11_19_19_score_0.7058.pkl" \
--model3="$ROOT/model/SC/2021_11_11_18_14_score_0.6984.pkl" \
--model4="$ROOT/model/SC/2021_11_12_15_44_score_0.6452.pkl" \
--model5="$ROOT/model/SC/2021_11_11_19_19_score_0.7058.pkl" \
--model_1="$ROOT/model/NER/2021_11_18_20_10_fold1__score_0.8387.pkl" \
--model_2="$ROOT/model/NER/2021_11_18_20_10_fold3__score_0.8172.pkl" \
--model_3="$ROOT/model/NER/2021_11_12_00_28_score_0.8367.pkl" \
--crf \
